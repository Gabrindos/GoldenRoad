...
@section('content')
    <div class="position-relative p-3 p-md-5 m-md-3 text-center"style="background-color: black;">
      <div class="col-md-5 p-lg-5 mx-auto my-5" >
        <h1 class="display-4 font-weight-normal text-white">Diretor</h1>
      </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align:center">
                            <a href="/Diretor/edit/{{$i['id']}}" class="btn btn-primary">Editar</a>
                            <a href="/Diretor/apagar/{{$i['id']}}" class="btn btn-danger" 
