...
@section('content')
    ...
    <div class="d-md-flex flex-md-equal w-100 my-md-3 pl-md-3">
      ...
      <h3 class="display-7 font-weight-small text-white">Adicionar Diretor</h3> <a href="/diretorfilme/{{$dados->id}}')" class="btn btn-light" style="color: black; border-width: 2px; border-color: black;">+</a>
                ...
                @forelse ($timesCampeonato as $item)
                    <tr>
                        ...
                        <td style="text-align:center">
                            <a href="/diretorfilme/apagar/{{$dados->id}}/{{$item->idTime}}" class="btn btn-danger" >Deletar</a>
                        </td>
                    </tr>  
                    @empty 
                        <tr>
