...
class ControllerTimeCampeonato extends Controller
{
    ...
    public function index($id)
    {
        ...
        */
        return view('exibeDiretorFilme', compact('dados', 'timesCampeonato'));
    ...
    public function create(string $id)
    {
        $dados = mdCampeonato::find($id);
        $times = mdTime::all();
        return view('novoDiretorFilme', compact('dados','times'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if($dados->save())
            return redirect('/filme')->with('success', 'Diretor do filme cadastrado com sucesso!!');
        return redirect('/filme')->with('danger', 'Erro ao cadastrar diretor do filme!');
    }
    ...
    public function destroy(string $idC, $idT)
    {
        ...
        return redirect('/filme')->with('success', 'Diretor do filme deletado com sucesso!!');
    }
}